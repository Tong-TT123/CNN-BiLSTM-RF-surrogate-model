...
elseif strcmp( method_mti,'MMGO映射改进MGO')==1
    [fMin,Mdl,Convergence_curve,pos]=MMGO_MMGO(pop,M,LB,UB,nvars,fit_fitrensemble1,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
elseif strcmp( method_mti,'GDOHLE柯西变异改进DOHLE')==1
    [fMin,Mdl,Convergence_curve,pos]=GDOHLE_GDOHLE(pop,M,LB,UB,nvars,fit_fitrensemble1,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
elseif strcmp( method_mti,'GAOO自适应t分布改进AOO')==1
    [fMin,Mdl,Convergence_curve,pos]=GAOO_GAOO(pop,M,LB,UB,nvars,fit_fitrensemble1,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
elseif strcmp( method_mti,'GCFO高斯精英变异改进CFO')==1
    [fMin,Mdl,Convergence_curve,pos]=GCFO_GCFO(pop,M,LB,UB,nvars,fit_fitrensemble1,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
elseif strcmp( method_mti,'MAOO螺旋搜索游走改进AOO')==1
    [fMin,Mdl,Convergence_curve,pos]=MAOO_MAOO(pop,M,LB,UB,nvars,fit_fitrensemble1,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
elseif strcmp( method_mti,'DOHLE豺优化算法')==1
    [fMin,Mdl,Convergence_curve,pos]=DOHLE_DOHLE(pop,M,LB,UB,nvars,fit_fitrensemble1,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
elseif strcmp( method_mti,'CFO冬虫夏草优化算法')==1
    [fMin,Mdl,Convergence_curve,pos]=CFO_CFO(pop,M,LB,UB,nvars,fit_fitrensemble1,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
elseif strcmp( method_mti,'AOO不实野燕麦优化算法')==1
    [fMin,Mdl,Convergence_curve,pos]=AOO_AOO(pop,M,LB,UB,nvars,fit_fitrensemble1,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
elseif strcmp( method_mti,'THRO田忌赛马优化算法')==1
    [fMin,Mdl,Convergence_curve,pos]=THRO_THRO(pop,M,LB,UB,nvars,fit_fitrensemble1,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
elseif strcmp( method_mti,'SSAKOA混合樽海鞘开普勒优化算法')==1
    [fMin,Mdl,Convergence_curve,pos]=SSAKOA_SSAKOA(pop,M,LB,UB,nvars,fit_fitrensemble1,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
...
%% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [best_fun,Mdl_best,cuve_f,prey_global] = DOHLE_DOHLE(N,T,lb,ub,dim,fobj,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
cuve_f=zeros(1,T);
X=initialization(N,dim,ub,lb); %Initialize population
global_Cov = zeros(1,T);
Best_fitness = inf;
...
fitness_f = zeros(1,N);
for i=1:N
    [fitness_f(i) ,model{1,i}] =fobj(X(i,:),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
...
while(t<=T)
    ...
    for i = 1:N
        ...
        if rand()<0.5
            ...
            prey_local_vlaue=fobj(prey_local,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm );      
    ...
    [localBest_fitness,Mdl_best] =  fobj(localBest_position,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm );      % Calculate the Value of Objective Function

    for i =1:N
        % Obtain the optimal solution for the updated population
        % local_fitness = fobj(Xnew(i,:));
        [local_fitness,model{1,i}] =  fobj(Xnew(i,:),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm );      % Calculate the Value of Objective Function
   ...
   % [localBest_fitness,Mdl_best] =  fobj(prey_global,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm );      % Calculate the Value of Objective Function
...
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [best_fun,Mdl_best,cuve_f,prey_global] = GDOHLE_GDOHLE(N,T,lb,ub,dim,fobj,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
cuve_f=zeros(1,T);
X=initialization(N,dim,ub,lb); %Initialize population
global_Cov = zeros(1,T);
Best_fitness = inf;
...
%柯西变异部分
    for j=1:2
        ...
        [fitness_f(j),model{1,j}] =  fobj(x_new,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm); %Calculate the fitness value of the function
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i =1:N
        % Obtain the optimal solution for the updated population
        % local_fitness = fobj(Xnew(i,:));
        [local_fitness,model1{1,i}] =  fobj(Xnew(i,:),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm );      % Calculate the Value of Objective Function
...
% function [best_fun,Mdl_best,cuve_f,prey_global] = DOHLE_DOHLE(N,T,lb,ub,dim,fobj,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
function [Best_Score,Mdl_best,convergence_curve,Best_X]=AOO_AOO(pop_size,iter_max,lb,ub,dim,fhd,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
% initialize
Best_Score=inf;
...
for i = 1:pop_size
    % Pop_Fit(i) = feval(fhd,X(i,:)',varargin{:});
     [Pop_Fit(i),model{1,i}] = fhd(X(i,:),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm );
...
%%Animated Oat Optimization Algorithm
% function [best_fun,Mdl_best,cuve_f,prey_global] = DOHLE_DOHLE(N,T,lb,ub,dim,fobj,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
function [Best_Score,Mdl_best,convergence_curve,Best_X]=GAOO_GAOO(pop_size,iter_max,lb,ub,dim,fhd,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
% initialize
Best_Score=inf;
convergence_curve=zeros(1,iter_max);
search_history = zeros(iter_max*pop_size, dim); % search history
...
%%
function [BestF,Mdl_best,Curve,BestS]=CFO_CFO(Search_Num1,Max_Iterations,lb,ub,dimension1,func,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
run_Num=1;
...
for k=1:run_Num
    ...
    for n=1:Search_Num1
       ...
       [Cordycepes_F(1,n),model{1,n}] = func( Cordycepes_P(n,:),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm );
    end
    Mdl_best=model{1,1};
    % Single iteration
    for it=1:Max_Iterations
        ...
        % research_operator
        [Cordycepes_P,Cordycepes_F,model] = Exploration_operator( Cordycepes_P, Cordycepes_F,model, ub, lb, it, Max_Iterations, func,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm );
        % parasitism_operation
        [Cordycepes_P,Cordycepes_F,model] = Parasitization_operation( Cordycepes_P, Cordycepes_F,model, ub, lb, it, Max_Iterations, func,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm );
        % Results Save
    ...
    function [newposition,newfitness,model] = Exploration_operator( Cordycepes_P, Cordycepes_F,model_input, Upper, Lower, it, Max_Iterations, func,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm )
        ...
        for n=1:Search_Num
            ...
            [Population_fitness(1,n),model{1,n} ]= func( Population_inf(n,:),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm );
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function [Cordycepes_P,Cordycepes_F,model] = Parasitization_operation( Cordycepes_P, Cordycepes_F,model_input, ub, lb, it, Max_Iterations, func,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm )
        [Search_Num,dimension] = size( Cordycepes_P );
        [~,index] = min( Cordycepes_F );
        for n=1:Search_Num
            if rand<0.5
...
%%
%%
function [BestF,Mdl_best,Curve,BestS]=GCFO_GCFO(Search_Num1,Max_Iterations,lb,ub,dimension1,func,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
run_Num=1;
Curve = zeros(run_Num,Max_Iterations);
BestF =zeros(run_Num,1);
BestS = zeros(run_Num,dimension1);
...
%%
function [BestFit,Mdl_best,His_BestFit,BestX]=THRO_THRO(nPop0,MaxIt,Low,Up,Dim,FOBJ,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
nPop0=nPop0*2;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
nPop=round(nPop0/2);
Low = Low.*ones(1,Dim);
...
for i=1:nPop
    ...
    [Tianji_PopFit(i),model1{1,i}]=FOBJ(Tianji_PopPos(i,:),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
    King_PopPos(i,:)=Low+rand(1,Dim).*(Up-Low);
    [King_PopFit(i),model2{1,i}]=FOBJ(King_PopPos(i,:),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
end
...
for It=1:MaxIt
    ...
    for i=1:nPop
        ...
        if Tianji_PopFit(Tianji_SlowestId)<King_PopFit(King_SlowestId)
            ...
            [Tianji_newPopFit,model_Tianji]=FOBJ(Tianji_newPopPos,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
           ...
           [King_newPopFit,model_king]=FOBJ(King_newPopPos,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
...
%%
function [Best_Score,Mdl_best,convergence_curve,Best_X]=MAOO_MAOO(pop_size,iter_max,lb,ub,dim,fhd,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
% initialize
Best_Score=inf;
convergence_curve=zeros(1,iter_max);
search_history = zeros(iter_max*pop_size, dim); % search history
...
%%
function [Fbest,Mdl_best,CNVG,Xbest]=PGA_PGA(N,T,lb,ub,dim,fobj,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
...
model1=[];model2=[];
for i=1:N
    [fitness(i),model{1,i}]=fobj(X(i,:),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
end
[GYbest, gbest] = min(fitness);
Xbest= X(gbest,:);
...
while t<T
    ...
    for i=1:size(Xs,1)
        ...
        [fitness_s(i),model1{1,i}]=fobj(Xs(i,:),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
    ...
    for i=1:size(Xl,1)
        ...
        % fitness_l(i) = feval(fobj,Xl(i,:));
         [fitness_l(i),model2{1,i}]=fobj(Xl(i,:),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
    ...
    for i=1:size(Xl,1)
        ...
        for j=1:2
            ...
            % fitness_lNew(j)=feval(fobj, Xlnew1(j,:));
             [fitness_lNew(j),model3{1,j}]=fobj(Xlnew1(j,:),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
   ...
   model3=[];
    for i=1:size(Xs,1)
        ...
        for j=1:2
            ...
            % fitness_sNew(j)=feval(fobj, Xsnew1(j,:));
              [fitness_sNew(j),model3{1,j}]=fobj(Xsnew1(j,:),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
    ...
    for i=1:N
        ...
        for j=1:1
            ...
            [fitnessn(j),model3{1,j}]=fobj(Xnew(j,:),train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
...
%%
function [Best_Cost, Mdl_best, Convergence_curve, Best_X] = MMGO_MMGO(nP, MaxIt, lb, ub, dim, fobj, train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
...
for i = 1:nP
    ...
    [Sol_Cost(i, :), model{1,i}] = fobj(X(i, :), train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
...
for Iter = 1:MaxIt
    ...
    for i = 1:nP
        ...
        [NewX, Sol_CostNew, model_new] = Boundary_Check(NewX, fobj, lb, ub, train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
...
% 边界检查函数（修改为支持返回模型）
    function [NewX, Sol_CostNew, model_new] = Boundary_Check(NewX, fobj, lb, ub, train_x, train_y, valid_x, valid_y)
        model_new = cell(1, size(NewX, 1));  % 存储新个体的模型
        for j = 1:size(NewX, 1)
            NewX(j, :) = boundaryCheck(NewX(j, :), lb, ub);
            % 计算适应度时传入训练/验证数据并获取模型
            [Sol_CostNew(j, :), model_new{1,j}] = fobj(NewX(j, :), train_x, train_y, valid_x, valid_y);
        end
    end
...
%%
function [FoodFitness,Mdl_best,Convergence_curve,FoodPosition]=SSAKOA_SSAKOA(N,Max_iter,lb,ub,dim,fobj, train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
if size(lb,2)<2
    lb=lb .* ones(1, dim);
    ub=ub .* ones(1, dim);
end
...
for i=1:size(SalpPositions,1)
    [SalpFitness(1,i),model{1,i}]=fobj(SalpPositions(i,:), train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
end
...
while l<Max_iter+1
    ...
    for i=1:size(SalpPositions,1)
        ...
        [PL_Fit1,model1]=fobj(SalpPositions(i,:), train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm);
